...
### Trouble Shooting
- 아직 큐가 좀 어색한 것 같다.
  - FIFO인 것까지는 기억나는데, front랑 rear가 괜히 헷갈림..
- 근데 사실 이 문제 왜 여기 와있는지 이해 안됨
  - 힙(heap) 공부하고 다시 보면 좋을 듯함
**문제풀이**
![image](https://github.com/user-attachments/assets/e170572a-9d30-489e-b709-6906ceb3969d)

...
### 출력 
 ...
 ### 🚀 Trouble Shooting
 - 전역 변수는 항상 헷갈려..
   - 함수 내에서 현재 상태(현재 값)을 알아야 하는 경우 불러와서 사용한다고 생각하면 될 듯 하다.
 - 슬라이딩 윈도우 문제 풀이를 위해서는 현재 상태를 체크하기 위한 리스트와 원하는 조건에 부합하는지를 확인하기 위한 체크 리스트, 즉 2개의 리스트를 요구한다는 점을 기억하자.
